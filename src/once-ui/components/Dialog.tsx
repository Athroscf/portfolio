    ...
    return ReactDOM.createPortal(
      ...
      >
        ...
        >
          ...
          <Flex as="section" paddingX="m" paddingY="s" overflowY="auto" direction="column">
            {children}
          </Flex>
          {(primaryButtonProps || secondaryButtonProps || dangerButtonProps) && (
            <Flex
              ...
              paddingBottom="m"
            >
              {dangerButtonProps && <Button {...dangerButtonProps} variant="danger" size="m" />}
              <Flex gap="8">
                {secondaryButtonProps && (
                  <Button {...secondaryButtonProps} variant="secondary" size="m" />
                )}
                {primaryButtonProps && (
