...
const RadioButton: React.FC<RadioButtonProps> = forwardRef<HTMLDivElement, RadioButtonProps>(
  (
    { style, className, isChecked: controlledIsChecked, onToggle, ...interactiveDetailsProps },
    ref,
  ) => {
    ...
    return (
      ...
      >
        ...
        <InteractiveDetails id={radioId} {...interactiveDetailsProps} onClick={toggleItem} />
      </Flex>
    );
  },
);
